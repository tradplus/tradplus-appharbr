...
public class VungleInterstitial extends Activity {
        ...
        findViewById(R.id.btn_displayAd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (customInterstitialAd != null) {
                    ...
                    // show ad
                    customInterstitialAd.showAd(VungleInterstitial.this,"");
                }
            }
        });
    ...
    private void initAndRequestAd() {
        ...
        tpInterstitial = new TPInterstitial(this, AdUnitIds.vungle_interstitial);
