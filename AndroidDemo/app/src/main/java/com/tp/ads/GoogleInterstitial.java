...
public class GoogleInterstitial extends Activity {
        ...
        findViewById(R.id.btn_displayAd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (customInterstitialAd != null) {
                    ...
                    // show ad
                    customInterstitialAd.showAd(GoogleInterstitial.this,"");
                }
            }
        });
    ...
    private void initAndRequestAd() {
        ...
        tpInterstitial = new TPInterstitial(this, AdUnitIds.google_interstitial);
